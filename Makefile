# $Id: Makefile,v 1.4 2013-03-27 21:56:48 ist169632 Exp $
#---------------------------------------------------------------
...
LFLAGS   = 
YFLAGS   = -dtv
CXXFLAGS = -std=c++11 -DYYDEBUG=1 -Wall -O3 -ggdb -fpermissive -Isemantics -I. -I$(CDK_INC_DIR) -I$(CDK_INC_DIR)/cdk
...
#---------------------------------------------------------------
# $Log: Makefile,v $
# Revision 1.4  2013-03-27 21:56:48  ist169632
# *** empty log message ***
#
# Revision 1.3  2013-03-24 20:19:32  ist169632
# fixed bugs
#
# Revision 1.2  2013-03-04 17:02:42  ist169632
# *** empty log message ***
#
