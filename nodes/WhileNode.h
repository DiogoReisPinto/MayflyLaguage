// $Id: WhileNode.h,v 1.2 2013-05-16 15:29:09 ist169632 Exp $ -*- c++ -*-
#ifndef __MF_WHILENODE_H__
#define __MF_WHILENODE_H__
...
namespace mayfly {
  namespace node {
    ...
    public:
      inline WhileNode(int lineno, cdk::node::expression::Expression *condition, cdk::node::Node *block) :
